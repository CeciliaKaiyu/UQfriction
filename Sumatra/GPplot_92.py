...
xtest = np.load(f"{pathtest}/x1.npy")
...
for i in index:
    ...
    plt.title(f"Gauge {i} Mw9.2")
    plt.savefig(f'./GP/GP92_coarse_{i+1}.png', bbox_inches='tight')
    plt.close()
    ...
    plt.title(f"Gauge {i} Mw9.2")
    plt.savefig(f'./GP/GP92_fine_{i+1}.png', bbox_inches='tight')
    plt.close()
